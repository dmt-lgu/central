...
import viteLogo from "/Logo-2.png";
...
import DICTLogo from "/DICT-Logo-Final-2-300x153.png";
import BPLogo from "/Bagong-Pilipinas-Logo.png";
...
function App() {
  ...
  useEffect(() => {
    ...
    if (services.includes('Business Permit')) {
      getBP();
    }
    ...
    <ThemeProvider defaultTheme="light" storageKey="vite-ui-theme">
      <div className="min-h-screen w-full flex">
        <nav className="fixed top-0 left-0 w-[20vw] md:hidden h-screen bg-[#0136a8] z-[99999] flex flex-col items-start p-5">
          <Link className="flex w-full justify-center mt-5 gap-2" to="/central/">
            <img src={viteLogo} className="logo h-12 object-contain self-center" alt="DICT logo" />
          </Link>
          ...
          <div className="flex gap-4 bg-[#181818] w-full justify-center py-4 absolute bottom-0 items-center self-center mb-10 "> 
            <img src={DICTLogo} className=" h-16 object-contain" alt="" />
            <img src={BPLogo} className=" h-[70px] object-contain" alt="" />
            
           
          </div>
          <p className=" text-white font-glight">version:2.1.0</p>
        </nav>

        <div className="flex-1 z-[99999] ml-[20vw] md:ml-0" ref={componentRef}>
